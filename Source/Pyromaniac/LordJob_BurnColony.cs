...
namespace RT
{
	public class LordJob_BurnColony : LordJob
	{
		...
		public LordJob_BurnColony()
		{
		}

		public LordJob_BurnColony(SpawnedPawnParams parms)
		{
		...
		public LordJob_BurnColony(Faction assaulterFaction, bool canKidnap = true, bool canTimeoutOrFlee = true, bool sappers = false, bool useAvoidGridSmart = false, bool canSteal = true)
		{
		...
		public override StateGraph CreateGraph()
		{
			...
			LordToil lordToil2 = new LordToil_BurnColony();
			if (useAvoidGridSmart)
			{
