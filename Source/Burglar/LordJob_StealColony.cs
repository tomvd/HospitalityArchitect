...
namespace RT
{
	public class LordJob_StealColony : LordJob
	{
		...
		public LordJob_StealColony()
		{
		}

		public LordJob_StealColony(SpawnedPawnParams parms)
		{
		...
		public LordJob_StealColony(Faction assaulterFaction, bool canKidnap = true, bool canTimeoutOrFlee = true, bool sappers = false, bool useAvoidGridSmart = false, bool canSteal = true)
		{
		...
		public override StateGraph CreateGraph()
		{
			...
			LordToil lordToil2 = new LordToil_StealColony();
