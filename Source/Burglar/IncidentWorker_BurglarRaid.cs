...
namespace RT
{
    public class IncidentWorker_BurglarRaid : IncidentWorker_RaidEnemy
    {
        ...
        protected override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            foreach (var pawn in list)
            {
                ...
                if (pawn.RaceProps.Humanlike)
                {
                    ...
                    {*/
                        ...
                        pawn.mindState.duty = new PawnDuty(RTDefOf.RT_StealColony);
                    //}
                }
                else
                {
            ...
            var lord = new LordJob_StealColony(parms.faction, false, true, true, true, true);
