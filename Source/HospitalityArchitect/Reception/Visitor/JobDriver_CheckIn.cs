...
namespace HospitalityArchitect.Reception
{
    ...
    public class JobDriver_CheckIn : JobDriver
    {
        ...
        private TargetIndex RegisterInd = TargetIndex.A;
        private TargetIndex QueueInd = TargetIndex.B;

        public override bool TryMakePreToilReservations(bool errorOnFailed)
        {
            return true; //pawn.Reserve(job.targetA.Thing, job);
        }
