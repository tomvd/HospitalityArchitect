...
namespace HospitalityArchitect
{
    ...
    public static class HADefOf
    {
        ...
        public static readonly JobDef HA_WatchYoutube;
        ...
        public static readonly ResearchProjectDef HA_OnlineMarketing;
        public static readonly ResearchProjectDef HA_TaxReduction;
        public static readonly GameConditionDef Pandemic;
