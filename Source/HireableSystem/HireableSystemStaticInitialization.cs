...
namespace RT
{
    ...
    public static class HireableSystemStaticInitialization
    {
        ...
        static HireableSystemStaticInitialization()
        {
            ...
            if (Hireables.Any())
            {
                RimworldTycoon.harmonyInstance.Patch(AccessTools.Method(typeof(Building_CommsConsole), nameof(Building_CommsConsole.GetCommTargets)),
                ...
                RimworldTycoon.harmonyInstance.Patch(AccessTools.Method(typeof(QuestUtility), nameof(QuestUtility.IsQuestLodger)),
                ...
                RimworldTycoon.harmonyInstance.Patch(AccessTools.Method(typeof(CaravanFormingUtility), nameof(CaravanFormingUtility.AllSendablePawns)),
                ...
                // RimworldTycoon.harmonyInstance.Patch(AccessTools.Method(typeof(PawnApparelGenerator), "GenerateWorkingPossibleApparelSetFor"),
                //     new HarmonyMethod(typeof(HireableSystemStaticInitialization), nameof(Debug)));
                RimworldTycoon.harmonyInstance.Patch(AccessTools.Method(typeof(BillUtility), nameof(BillUtility.IsSurgeryViolationOnExtraFactionMember)),
                                              postfix: new HarmonyMethod(typeof(HireableSystemStaticInitialization), nameof(IsSurgeryViolation_Postfix)));
                RimworldTycoon.harmonyInstance.Patch(AccessTools.Method(typeof(ForbidUtility), nameof(ForbidUtility.CaresAboutForbidden)),
        ...
        public static IEnumerable<ICommunicable> GetCommTargets_Postfix(IEnumerable<ICommunicable> communicables) {
                return communicables.Concat(Hireables).Concat(new Comms_Caller());
        }
        ...
        {
            __result = __result && (!GetContractTracker(Find.World).IsHired(pawn) || pawn.CurJobDef != RTDefOf.RT_LeaveMap);
        }
    }
